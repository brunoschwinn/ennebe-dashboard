...
const PV = [
  ...
  {w:"23/01",leads:31,qual:5, taxaQ:16.1,brSem:11},
  {w:"30/01",leads:47,qual:17,taxaQ:36.2,brSem:2},
  {w:"06/02",leads:28,qual:7, taxaQ:25.0,brSem:2},
...
const PV_C=[
  {w:"12/12",leads:39,qual:16},{w:"19/12",leads:27,qual:15},{w:"09/01",leads:24,qual:9},
  {w:"16/01",leads:25,qual:11},{w:"23/01",leads:31,qual:5},{w:"30/01",leads:47,qual:17},
  {w:"06/02",leads:28,qual:7},{w:"13/02",leads:48,qual:17},{w:"20/02",leads:42,qual:8},
  {w:"01/03",leads:56,qual:8},
];
const PV_A=[{w:"13/02",leads:8,qual:4},{w:"20/02",leads:24,qual:12},{w:"01/03",leads:20,qual:5}];

const VD = [
  {w:"12/12",cS:0, vS:0,      cM:0,  vM:0,      nQ:10,pipe:0,   cart:0       },
  {w:"19/12",cS:2, vS:54700,  cM:0,  vM:0,      nQ:7, pipe:0,   cart:0       },
  {w:"09/01",cS:1, vS:2900,   cM:1,  vM:2900,   nQ:5, pipe:14,  cart:1157160 },
  {w:"16/01",cS:2, vS:82389,  cM:3,  vM:85289,  nQ:17,pipe:20,  cart:1156580 },
  {w:"23/01",cS:2, vS:18420,  cM:5,  vM:103709, nQ:19,pipe:45,  cart:1735049 },
  {w:"30/01",cS:8, vS:107902, cM:13, vM:211611, nQ:23,pipe:51,  cart:1787764 },
  {w:"06/02",cS:2, vS:12210,  cM:2,  vM:12210,  nQ:27,pipe:76,  cart:2040994 },
  {w:"13/02",cS:2, vS:50000,  cM:4,  vM:62210,  nQ:11,pipe:62,  cart:2116056 },
  {w:"20/02",cS:4, vS:83886,  cM:8,  vM:146096, nQ:8, pipe:69,  cart:2186056 },
  {w:"01/03",cS:6, vS:245885, cM:13, vM:376931, nQ:13, pipe:71,  cart:2485305 },
];
const VD_C=[
  {w:"12/12",vS:0,     cart:null   },{w:"19/12",vS:54700, cart:null   },
  {w:"09/01",vS:2900,  cart:1157160},{w:"16/01",vS:82389, cart:1156580},
  {w:"23/01",vS:4420,  cart:1364865},{w:"30/01",vS:91099, cart:1402580},
  {w:"06/02",vS:0,     cart:1703840},{w:"13/02",vS:15000, cart:1745220},
  {w:"20/02",vS:71260, cart:1795220},
  {w:"01/03",vS:245885,cart:1807468},
];
const VD_A=[
  {w:"23/01",vS:14000, cart:370184},{w:"30/01",vS:16803,cart:386987},
  {w:"06/02",vS:12210, cart:397154},{w:"13/02",vS:35000,cart:350836},
  {w:"20/02",vS:12626, cart:390836},
  {w:"01/03",vS:0,     cart:677836},
];

const CF = [
  {w:"12/12",conf:15,aConf:0, atr:5, val:45500},{w:"19/12",conf:5, aConf:0, atr:5, val:45500},
  {w:"09/01",conf:5, aConf:0, atr:17,val:64600},{w:"16/01",conf:8, aConf:0, atr:28,val:106400},
  {w:"23/01",conf:5, aConf:1, atr:38,val:144400},{w:"30/01",conf:5,aConf:3, atr:35,val:133000},
...
const PROD = [
  {w:"12/12",ini:5, fin:3, tmed:3},{w:"19/12",ini:8, fin:7, tmed:3},
  {w:"09/01",ini:10,fin:8, tmed:4},{w:"16/01",ini:12,fin:10,tmed:4},
...
const PREMONT=[
  {w:"16/01",ini:6,fin:2,tmed:1},{w:"23/01",ini:7,fin:5,tmed:1},
  {w:"30/01",ini:6,fin:7,tmed:1},{w:"06/02",ini:8,fin:5,tmed:2},
  {w:"13/02",ini:5,fin:5,tmed:2},{w:"20/02",ini:3,fin:2,tmed:2},
];

const MONT = [
  {w:"12/12",ini:5, conc:1, pend:null},{w:"19/12",ini:4, conc:2, pend:null},
  {w:"09/01",ini:3, conc:1, pend:null},{w:"16/01",ini:2, conc:2, pend:null},
  {w:"23/01",ini:3, conc:2, pend:null},{w:"30/01",ini:4, conc:2, pend:null},
  {w:"06/02",ini:2, conc:1, pend:8  },{w:"13/02",ini:3, conc:2, pend:5  },
  {w:"20/02",ini:1, conc:1, pend:10 },
  {w:"01/03",ini:3, conc:3, pend:10 },
];

const AT = [
  {w:"12/12",aberto:43,cham:0, ini:0, fin:4},{w:"19/12",aberto:38,cham:2, ini:1, fin:2},
  {w:"09/01",aberto:36,cham:4, ini:3, fin:3},{w:"16/01",aberto:34,cham:3, ini:2, fin:3},
  {w:"23/01",aberto:30,cham:3, ini:2, fin:4},{w:"30/01",aberto:24,cham:5, ini:4, fin:4},
  {w:"06/02",aberto:20,cham:2, ini:1, fin:3},{w:"13/02",aberto:17,cham:3, ini:3, fin:4},
  {w:"20/02",aberto:15,cham:5, ini:4, fin:4},
  {w:"01/03",aberto:24,cham:14,ini:7, fin:5},
];

const SAC = [
  {w:"12/12",cobr:2, cont:0, ra:0,goo:0,resol:0,ret:0,nps:null,nota:null},
  {w:"19/12",cobr:5, cont:0, ra:0,goo:0,resol:0,ret:0,nps:null,nota:null},
  {w:"09/01",cobr:8, cont:0, ra:0,goo:0,resol:0,ret:0,nps:null,nota:null},
  {w:"16/01",cobr:12,cont:0, ra:0,goo:0,resol:0,ret:0,nps:null,nota:null},
  {w:"23/01",cobr:15,cont:0, ra:0,goo:0,resol:0,ret:0,nps:null,nota:null},
  {w:"30/01",cobr:21,cont:0, ra:0,goo:0,resol:5,ret:5,nps:null,nota:null},
  {w:"06/02",cobr:18,cont:0, ra:0,goo:0,resol:0,ret:0,nps:null,nota:null},
  {w:"13/02",cobr:15,cont:2, ra:2,goo:4,resol:2,ret:0,nps:60,  nota:8.8},
  {w:"20/02",cobr:17,cont:3, ra:2,goo:4,resol:3,ret:0,nps:60,  nota:8.8},
  {w:"01/03",cobr:29,cont:3, ra:2,goo:4,resol:1,ret:0,nps:null,nota:null},
];

const FIN = [
  {w:"12/12",mg:81.8,cond100:false},{w:"19/12",mg:78.2,cond100:false},
  {w:"09/01",mg:76.4,cond100:true},{w:"16/01",mg:74.1,cond100:true},
  {w:"23/01",mg:72.8,cond100:true},{w:"30/01",mg:71.5,cond100:true},
  {w:"06/02",mg:70.9,cond100:true},{w:"13/02",mg:71.2,cond100:true},
...
const RH = [
  {w:"12/12",total:34,loja:17,fab:17,abs:15.9,turn:0,   hexLoja:14.23,hexFab:9.77,hexTotal:67.93},
  {w:"19/12",total:34,loja:17,fab:17,abs:12.4,turn:0,   hexLoja:12.5, hexFab:8.2, hexTotal:55.0},
  {w:"09/01",total:35,loja:17,fab:18,abs:8.1, turn:0,   hexLoja:10.2, hexFab:12.5,hexTotal:52.3},
  {w:"16/01",total:35,loja:17,fab:18,abs:6.2, turn:1.4, hexLoja:9.5,  hexFab:15.3,hexTotal:56.8},
  {w:"23/01",total:35,loja:17,fab:18,abs:4.8, turn:0,   hexLoja:8.8,  hexFab:18.2,hexTotal:59.4},
  {w:"30/01",total:36,loja:17,fab:19,abs:3.5, turn:0,   hexLoja:10.1, hexFab:22.4,hexTotal:62.8},
  {w:"06/02",total:36,loja:16,fab:20,abs:2.9, turn:0,   hexLoja:11.0, hexFab:35.6,hexTotal:57.2},
  {w:"13/02",total:36,loja:16,fab:20,abs:2.6, turn:0,   hexLoja:12.3, hexFab:38.9,hexTotal:58.6},
  {w:"20/02",total:36,loja:16,fab:20,abs:2.4, turn:1.4, hexLoja:11.52,hexFab:40.78,hexTotal:52.3},
  {w:"01/03",total:35,loja:16,fab:19,abs:3.41,turn:1.43,hexLoja:39.77,hexFab:75.40,hexTotal:115.17},
];

const MKT=[
  {w:"13/02",ennInv:2084,ennRoas:7.19, ennCpc:.47,ennAc:2987,seg:10709,ideInv:320,ideRoas:109.43,ideCpc:null,ideRejeicao:57.5,ennRejeicao:92.1},
  {w:"20/02",ennInv:2226,ennRoas:32.46,ennCpc:.41,ennAc:2874,seg:10738,ideInv:512,ideRoas:0,    ideCpc:null,ideRejeicao:56.2,ennRejeicao:91.2},
  {w:"01/03",ennInv:1896,ennRoas:71.05,ennCpc:.19,ennAc:2253,seg:10813,ideInv:373,ideRoas:0,    ideCpc:1.28, ideRejeicao:57.1,ennRejeicao:93.3},
];
